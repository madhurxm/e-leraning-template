                ...
                <div class="col-lg-2 text-center">
                    <div class="d-grid gap-2">
                        <button type="button" name="" id="add_button"
                            class="btn btn-primary rounded-pill py-3 px-5 text-center">ADD
                            COURSES</button>
                    </div>
                </div>
                {{-- ADD Button End --}}
                ...
                <div class="col-lg-2 text-center">
                    <div class="d-grid gap-2">
                        <button type="button" name="" id="edit_button"
                            class="btn btn-primary rounded-pill py-3 px-5 text-center">EDIT
                            COURSES</button>
                    </div>
                </div>
                {{-- EDIT Button End --}}
                                ...
                                <div class="row m-4">
                                    ...
                                    <div class="col m-1">
                                        ...
                                        <button type="button" name="" id=""
                                            class="btn btn-primary rounded-pill text-center m-2 px-4 py-2 remove_create_form">
                ...
                <div class="row m-4">
                    <div class="col">
                        ...
                        <button type="button" name="" id="load_another_form"
                            class="btn btn-primary rounded-pill text-center m-2 px-4 py-2">
