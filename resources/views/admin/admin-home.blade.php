...
<body>
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="{{URL::asset('assets/admin/index.html')}}" class="navbar-brand mx-4 mb-3">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{URL::asset('assets/admin/widget.html')}}" class="nav-item nav-link"><i
                            class="fa fa-th me-2"></i>Widgets</a>
                    <a href="{{URL::asset('assets/admin/form.html')}}" class="nav-item nav-link"><i
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="{{URL::asset('assets/admin/signin.html')}}" class="dropdown-item">Sign In</a>
                            <a href="{{URL::asset('assets/admin/signup.html')}}" class="dropdown-item">Sign Up</a>
                            <a href="{{URL::asset('assets/admin/404.html')}}" class="dropdown-item">404 Error</a>
                            <a href="{{URL::asset('assets/admin/blank.html')}}" class="dropdown-item">Blank Page</a>
                        </div>
                    </div>
                </div>
            </nav>
    ...
    <script src="{{ URL::asset('assets/admin/lib/tempusdominus/js/moment-timezone.min.js')}}"></script>
    <script src="{{ URL::asset('assets/admin/lib/tempusdominus/js/tempusdominus-bootstrap-4.min.js')}}">
    </script>
