                            ...
                            <div>
                                <div class="col-lg-12 text-center">
                                    ...
                                    <div id="form_to_be_clone_div" hidden>
                                        <form method="post" class="form_to_be_clone"
                                            id="template_form">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <div
                                                            ...
                                                            <input type="file"
                                                                ...
                                                                name="course_picture"
                                                                placeholder="Code 1">
                                                            <label for="course_picture">Choose
                                                                Course
                                                                Picture</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <div
                                                            ...
                                                            <input type="file"
                                                                ...
                                                                name="course_picture"
                                                                placeholder="course_picture">
                                                            <!-- <label for="course_picture">Choose Course Picture</label> -->
                                                </td>
                        </div>
                    </div>
                    <td class="w-auto">
